...
- Apenas a racionalidade e informações disponíveis.
...
- Julgar a probabilidade de um evento pela facilidade com que se pode lembrar de exemplos ou informações relacionadas. 
- Exemplo: Um investidor que ouve notícias sobre quedas na bolsa e superestima a probabilidade de uma crise, vendendo suas ações.

#### Heurística da Representatividade
- Julgar a probabilidade de um evento com base em estereótipos pré-existentes, sem considerar a probabilidade real (leva ao Viés de Confirmação). 
- Exemplo: Um investidor vê uma nova fintech e, baseado no sucesso de outras empresas de tecnologia, assume que esta também terá sucesso, ignorando a análise financeira.

#### Heurística da Ancoragem
- Basear-se em uma informação específica (âncora) para tomar decisões, mesmo que essa informação seja irrelevante. 
- Exemplo: Um investidor avalia uma ação como valiosa apenas porque seu preço inicial é alto, sem analisar os fundamentos que suportem essa valorização.
