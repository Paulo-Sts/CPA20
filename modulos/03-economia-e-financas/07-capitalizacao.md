...
## 4. Comparações entre os Regimes

| OPERAÇÃO                                    | TAXA PROPORCIONAL (SIMPLES) | TAXA EQUIVALENTE (COMPOSTA) | CONCLUSÃO                                                                      |
|:--------------------------------------------|:----------------------------|:----------------------------|:-------------------------------------------------------------------------------|
| Capitalização (Período menor para maior)    | Menor                       | Maior                       | O juro composto é melhor para quem investe.                                    |
| Descapitalização (Período maior para menor) | Maior                       | Menor                       | O juro simples é maior, sendo pior para o investidor. (melhor para quem paga). |
