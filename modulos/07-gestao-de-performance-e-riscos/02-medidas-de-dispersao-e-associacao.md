...
### I. Medidas de Dispersão (Risco e Volatilidade)
...
### II. Medidas de Associação (Relação entre Variáveis)
...
#### B. Coeficiente de Correlação Linear de Pearson ($\rho$)
...
### III. Distribuição Normal (Curva de Sino)
...
[Link para o vídeo](http://www.youtube.com/watch?v=4ZDntqX-3z8)